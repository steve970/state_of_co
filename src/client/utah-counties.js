// Utah Counties D3.js visualization - based on Colorado counties
class UtahCountiesMap {
    constructor() {
        ...
        // Color scale for choropleth (jobs-based) - same as Colorado
        this.colorScale = d3.scaleLinear()
            .domain([0, 500000])
            .range(['#BFD3E6', '#88419D']); // Same as Colorado
    ...
    handleClick(event, d) {
        ...
        // Could add navigation to county detail page here
    }
    ...
    addLegend() {
        ...
        // Create color swatches with labels - same as Colorado
        ...
        legend.append('text')
            ...
            .style('font-size', '9px')
            .style('fill', '#95a5a6')
            .text('Data: Bureau of Labor Statistics');
    ...
    renderCountyCities(counties, countiesData) {
        ...
        countiesWithCities.forEach(county => {
            ...
            if (screenCoords && screenCoords[0] >= 0 && screenCoords[0] <= this.width && 
                screenCoords[1] >= 0 && screenCoords[1] <= this.height) {
